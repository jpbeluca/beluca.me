  ...
  experience: [
    {
      ...
      blurb: "Technology consulting firm specializing in solution architecture and cloud-based systems.",
      bullets: [
  ...
  projects: [
    {
      ...
      summary: "An agentic conversational layer embedded into a CRM. Sales directors ask questions in natural language; the agent runs SQL via tool-calling and enriches answers with RAG over historical data.",
      stack: [
        "OpenAI",
        "Tool-calling",
        "Vector DB",
      ...
      impact: "Became a daily tool for the commercial team — accelerated deal prep, cut prep time before client visits.",
      details: [
    ...
    },
    {
      ...
      summary: "Custom CRM for a 300+ person manufacturing group with hundreds of millions in annual revenue. Centralizes commercial operations end-to-end.",
      stack: ["AWS EC2", "S3", "SES", "REST APIs", "Google APIs", "ERP Integration"],
      impact: "Core daily system for sales and customer management — improved data consistency, reduced manual work.",
      details: [
    ...
    },
    {
      ...
      year: "2019-2022",
      role: "Solutions Architect",
      summary: "Cloud platform for hospital operations — real-time tracking of medical assets and patient flow via RFID/IoT.",
      stack: ["Event-Driven", "RFID/IoT", "AWS", "Analytics Dashboards"],
      impact: "Mission-critical system supporting daily hospital workflows. Improved asset utilization, reduced operational waste.",
      details: [
